...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] bg-transparent  flex flex-col items-center py-60 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      {/* Lid */}
      <Lid src={src} scaleX={scaleX} scaleY={scaleY} rotate={rotate} translate={translate} />
      {/* Base area */}
      <div className="h-88 w-160 bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
        <div className="h-10 w-full relative">
          <div className="absolute inset-x-0 mx-auto w-[80%] h-4 bg-[#050505]" />
        </div>
        <div className="flex relative">
          <div className="mx-auto w-[15%] overflow-hidden  h-full">
            <SpeakerGrid />
          </div>
        ...
        {showGradient && (
          <div className="h-40 w-full absolute bottom-0 inset-x-0 bg-linear-to-t dark:from-black from-white via-white dark:via-black to-transparent z-50" />
        )}
  ...
  return (
    <div className="relative perspective-midrange">
      <div
        ...
        className="h-48 w-160 bg-[#010101] rounded-2xl p-2 relative"
      >
        <div
          style={{
      ...
      <motion.div
        ...
        className="h-96 w-160 absolute inset-0 bg-[#010101] rounded-2xl p-2"
      >
        <div className="absolute inset-0 bg-[#272729] rounded-lg" />
        <Image
          src={src ?? '/1_endpoint.webp'}
          alt="Mockify App Screenshot"
          fill
          unoptimized
...
export const Keypad = () => {
  return (
    <div className="h-full w-full rounded-md bg-[#050505] mx-auto p-1">
      {/* First Row */}
      <Row>
      ...
      <Row>
        <KBtn
          className="w-[2.8rem] items-end justify-start pl-1 pb-0.5"
      ...
      <Row>
        <KBtn
          className="w-[3.65rem] items-end justify-start pl-1 pb-0.5"
          childrenClassName="items-start"
        >
          shift
        </KBtn>
      ...
      <Row>
        ...
        <div className="w-[4.9rem] mt-0.5 h-6 p-[0.5px] rounded-sm flex flex-col justify-end items-center">
...
export const KBtn = ({
  ...
  return (
    <div className={cn('p-[0.5px] rounded-sm', backlit && 'bg-white/20 shadow-xl shadow-white')}>
      <div
        className={cn(
...
export const Row = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex gap-0.5 mb-[2px justify-center items-center w-full shrink-0">
      {children}
    </div>
  )
}
